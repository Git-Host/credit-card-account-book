...
public interface CategoryList {
	...
	/*기타*/			{{},
	/*식비*/			{"마트","정육","슈퍼"},{"베이커리","바게트","파닭","치킨","BBQ","피자","피치홈","분식"},{"탐앤탐스","스타벅스","카페베네","엔제리너스","파스꾸찌","피자","윤가네","용우동","베스킨"},{"밥앤죽","맥도날드","베니건스","아웃백","빕스","KFC","TGIF","레스토랑","순대","본죽","윤가네"},{"스타우트","옛고을","족발","호프","거품"},
	/*주거/통신*/		{},{},{"핸드폰"},{"브로드"},{},
	/*생활용품*/		{},{},{"세븐일레븐","GS25","훼미리마트","미니스톱"},{"다이소"},
	/*의복/미용*/		{},{},{"헤어샵","미용실"},{},
